            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="nama_dosen" class="col-md-4 col-form-label text-md-end">{{ __('Name') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="alamat" class="col-md-4 col-form-label text-md-end">{{ __('Homebase') }}</label>
