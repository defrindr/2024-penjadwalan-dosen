...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="https://e7.pngegg.com/pngimages/296/364/png-clipart-schedule-employee-scheduling-software-management-computer-software-schedule-miscellaneous-text.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <li class="nav-item {{ isActiveDosen() ? 'menu-open' : '' }}">
              <a href="{{ asset('/dosen') }}" class="nav-link {{ Request::is('dosen') ? 'active' : '' }}">
            ...
            @endif
            <li class="nav-item {{ isActiveLogout() ? 'menu-open' : '' }}"> <!-- Menentukan apakah link logout aktif -->
